...
class __TwigTemplate_b7d0c4f4ad2e24b12571eaef523f44c0 extends Template
{
    private $source;
    private $macros = [];
...
echo _gettext("Your preferences will be saved for current session only. Storing them permanently requires %sphpMyAdmin configuration storage%s.");
    ...
    {
        return new Source("", "preferences/header.twig", "/var/www/html/phpmyadmin/templates/preferences/header.twig");
    }
}
